...
- Status: ❌ Erro 503 "no available server"
- **PROBLEMA IDENTIFICADO:** ❌ `OPENAI_API_KEY não configurada`
- **SOLUÇÃO:** Adicionar variável `OPENAI_API_KEY` no Coolify (veja SOLUCAO_OPENAI_KEY.md)
...
3. Salve (será feito redeploy automático)
